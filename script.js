...
const CONTENT_ES = {
  ...
  academic: { title:'Academico', cards:[
  ...
  projects: { title:'Proyectos', cards:[
    { title:'Pet Finder App', meta:'Mobile Development', body:'App dinamica para encontrar mascotas perdidas utilizando sistemas de autenticación de solicitudes (JWT), creación de cuentas y comunicación con un servidor y base de datos (MongoDB), usando Docker-Compose para aislar el entorno de desarrollo..', tags:['React Native','Express','MongoDB','Docker','JWT','Backend','Frontend'], link:'https://github.com/lautaorsi/pet-finder', linkText:'Ver Repositorio' },
    { title:'Videojuego Online Geografía', meta:'Multiplayer', body:'Juego online de geografía, empleando distintas API`s, tecnicas anti-exploits y mantenimiento del servidor.', tags:['Node.js','Socket.io','Leaflet','Javascript','Backend','Frontend'], link:'https://github.com/lautaorsi/pet-finder' ,linkText:'Ver Repositorio'},
    { title:'WhatsApp Scraper', meta:'Data Analysis', body:'Pequeño proyecto que scrappea chats entre dos o mas usuarios para generar estadisticas y datos relevantes de las conversaciónes.', tags:['Python','Regex','MatPlotLib','Backend'], link:'https://github.com/lautaorsi/pet-finder' ,linkText:'Ver Repositorio'},
  ]},
  courses: { title:'Cursos', cards:[
    { title: 'Machine Learning with Python', meta:'Machine Learning', body:'Curso aplicado de Machine Learning de IBM (en curso)', tags:['Python','Machine Learning','Backend'], linkText:'Ir al repositorio', link:'https://github.com/lautaorsi/AI-IBM-COURSE'},
    { title:'Google Cybersecurity Specialization', meta:'Ciberseguridad', body:'Curso de ciberseguridad teorico y practico', tags:['Linux','SQL','Python','Windows','Backend'], linkText:'Certificado', link:'https://coursera.org/share/a733688561956f4471289add8737c8f0'},
    ...
    { title: 'API Development and Architecture', meta:'API`s', body: 'Curso de APIs, testing y arquitectura', tags:['Python','Flask','Postman','API','Backend'],linkText:'Ir a Repositorio',link:'https://github.com/lautaorsi/API-Course'},
    { title:'Linux Server Management and Security', meta:'Ciberseguridad', body:'Curso de seguridad en Linux.', tags:['OS','SQL','Databases','Backend'],linkText:"Certificado", link:"https://coursera.org/share/6770bf6fd701df4d06230ef2fdd019a2" },
    { title:'Introduction to Databases', meta:'General', body:'Curso inicial de Bases de Datos.', tags:['SQL','Backend'], linkText:"Certificado", link:"https://coursera.org/share/934b732b8048ae9f5b41a90240926343" },
  ]},
