export const CONTENT = {
  ...
  projects: { title:'Proyectos', cards:[
    ...
    { title:'Videojuego Online Geografía', meta:'Multiplayer', body:'Juego online de geografía, empleando distintas API`s, tecnicas anti-exploits y mantenimiento del servidor.', tags:['Node.js','Socket.io','Leaflet','Javascript'], link:'https://github.com/lautaorsi/guessr' ,linkText:'Ver Repositorio'},
    { title:'WhatsApp Scraper', meta:'Data Analysis', body:'Pequeño proyecto que scrappea chats entre dos o mas usuarios para generar estadisticas y datos relevantes de las conversaciónes.', tags:['Python','Regex','MatPlotLib'], link:'https://github.com/lautaorsi/Whatsapp-Scrapper' ,linkText:'Ver Repositorio'},
  ]},
